...
function validerReponse() {
  ...
  if (currentQuestionIndex < examen.questions.length) {
    setTimeout(afficherQuestion, 400); // petite pause pour transition
  } else {
    localStorage.setItem("resultat_final", JSON.stringify({
      score: score,
      total: examen.questions.reduce((s, q) => s + q.note, 0),
      bonnes: reponsesCorrectes,
      mauvaises: reponsesIncorrectes,
    }));
